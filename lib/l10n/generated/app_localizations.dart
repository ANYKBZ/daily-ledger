...
abstract class AppLocalizations {
  ...
  /// No description provided for @convertAmountsToCny.
  ///
  /// In en, this message translates to:
  /// **'Convert transaction amounts to Chinese yuan'**
  String get convertAmountsToCny;

  /// No description provided for @showAmountsInUsd.
  ///
  /// In en, this message translates to:
